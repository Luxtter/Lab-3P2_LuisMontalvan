        ...
        while (opc != 8) {
            ...
            switch (opc) {
                ...
                case 6:
                    ...
                    int resp = 0;
                    while (resp != 2) {
                        System.out.print("--Productos--\n" + cadena4 + "\nElija un producto que desea comprar: ");
                        pochita = new Scanner(System.in);
                        int pro = pochita.nextInt();
                        if (pro >= 0 && pro < productos.size()) {
                            listacomp.add(productos.get(pro));
                        }else{
                    ...
                    for (Producto t : listacomp) {
                        cadenaf+= t+"..."+t.getPrecio()+"lps.\n";
